// Similar structure and styling as VolumeScreen but with a different title
import React from 'react';
import { View, Text, TouchableOpacity, StyleSheet, ScrollView } from 'react-native';

const AboveGroundBiomassScreen = () => {
    return (
...
export default AboveGroundBiomassScreen;

const styles = StyleSheet.create({
    // Same styles as VolumeScreen
    container: {
        flex: 1,
